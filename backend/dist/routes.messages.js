...
router.get("/", requireAuth, (req, res) => {
    ...
    const rows = before
        ...
        : db
            .prepare("SELECT id, role, content, created_at FROM messages WHERE character_id = ? AND user_id = ? ORDER BY created_at DESC LIMIT ?")
...
//# sourceMappingURL=routes.messages.js.map